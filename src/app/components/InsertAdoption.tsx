...
const InsertAdoption = () => {
    ...
    const onSubmit: SubmitHandler<Schema> = async (data) => {
        ...
        const { error: insertError } = await supabase.from('adoption').insert({
            profile_id: user.id,
    ...
    return (
        <div className="min-h-full flex items-center justify-center mt-16 mb-32">
            <div className="max-w-lg w-full space-y-8">
                <h2 className="text-center text-2xl font-bold">譲渡猫の登録</h2>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mb-10">
                        <label htmlFor="detail" className="text-md font-bold">概要</label>
                        <textarea
                            autoComplete="none" 
