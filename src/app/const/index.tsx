...
export const PEDIGREE = [
    ...
    {
        pediCode: 5,
        pediName: 'アメリカンワイヤーヘア',
    },
    {
        pediCode: 6,
        pediName: 'エキゾチックショートヘア',
    },
    {
        pediCode: 7,
        pediName: 'エジプシャウマウ',
